...
namespace eDrive
{
    ...
    public static class Utility
    {
        ...
        /// <returns>
        ///     true if the difference between the values is less than or equal to <paramref name="proximityThreshold" />; otherwise, false.
        /// </returns>
        ...
        {
            var difference = value1 > value2 ? value1.Subtract(value2) : value2.Subtract(value1);
        ...
        /// <returns>
        ///     true if <paramref name="value" /> represents a numeric value; otherwise, false.
        /// </returns>
        ...
        /// <returns>
        ///     An array of <see cref="Enum" /> values present within the enumeration.
        /// </returns>
        ...
        /// <param name="length">The number of elements to copy.</param>
        /// <returns>A copy of the subset of the source array.</returns>
        public static byte[] CopySubArray(this byte[] source, int start, int length)
        {
        ...
        /// <summary>
        ///     Swaps the endian in place.
        /// </summary>
        /// <param name="data">The data.</param>
        /// <param name="offset">The offset.</param>
        /// <param name="length">The length.</param>
        public static void SwapEndianInPlace(ref byte[] data, int offset = 0, int length = 0)
        {
            var start = offset;
            if (length == 0)
            {
        ...
        /// <exception cref="ArgumentException">
        ///     <paramref name="minValue" /> is greater than or equal to <paramref name="conditionCount" />. -or-
        ///     <paramref
        ///         name="seed" />
        ///     is less
        ///     than <paramref name="minValue" />. -or- <paramref name="seed" /> is greater than or equal to
        ///     <paramref
        ///         name="conditionCount" />
        /// </exception>
        public static int[] BuildLatinSquareRow(int seed, int minValue, int conditionCount)
        {
            ...
            for (var i = seed; i < conditionCount; i++)
            {
                row.Add(i);
            }
